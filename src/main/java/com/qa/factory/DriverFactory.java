...
public class DriverFactory {
	...
	public WebDriver int_driver(String Port)  throws MalformedURLException {
        ...
        {
            nodeURL = "http://127.0.0.1:4546/wd/hub";
            ...
            {
                nodeURL = "http://127.0.0.1:5566/wd/hub";
                ...
                capabilities1.setPlatform(Platform.UNIX);
...
//		} else {
//			System.out.println("Lütfen doðru tarayýcý deðeri girin " + browser);
//		}
